...
const InboundRegistration = () => {
	...
	const columns = [
		...
		},
		{
			...
			render: (_, record, index) => (
				<div>
					{userPerm &&
					userPerm.perm_update_inboundregistration === "1" &&
					...
					{userPerm &&
					userPerm.perm_delete_inboundregistration === "1" &&
	...
	const processDataForExcel = () => {
		return data.map((record) => {
			...
			let selVehicle = vehicles?.filter(
			...
			{loading ? (
				...
				<div>
					<PageLayout
						...
						titleRightAction={() =>
							userPerm &&
							userPerm.perm_create_inboundregistration === "1" &&
